...
export function createFacilityView(React:typeof ReactTypes,Art:ReactTypes.ComponentType<{id:SpeciesId;variant?:Variant|null}>){
  ...
  return function Facility({id,data,onManage,onTalk,onStories}:{id:FacilityId;data:Bootstrap;onManage:(area:'aquarium'|'shelf'|'decor')=>void;onTalk:()=>void;onStories:()=>void}){
