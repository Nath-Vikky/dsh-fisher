...
.dsh-fisher-hud-menu,.dsh-fisher-world-waypoints,.dsh-fisher-world-interaction,.dsh-fisher-hud-fishing{pointer-events:none}.dsh-fisher-hud-menu button,.dsh-fisher-world-waypoints button,.dsh-fisher-world-interaction button,.dsh-fisher-hud-fishing button{pointer-events:auto}
...
.dsh-fisher-auto-controls{display:flex;align-items:center;gap:8px;margin:0 0 8px;padding-bottom:7px;border-bottom:1px solid var(--fisher-ink)}
.dsh-fisher-auto-controls .dsh-fisher-toggle{margin:0}.dsh-fisher-auto-controls .dsh-fisher-link{margin-left:auto;padding:0;font-size:11px}
.dsh-fisher-auto-actions{display:flex;align-items:center;gap:14px;margin-top:10px}.dsh-fisher-auto-actions .dsh-fisher-primary{flex:1;width:auto;margin:0}.dsh-fisher-auto-actions .dsh-fisher-quiet-actions{margin:0;white-space:nowrap}
.dsh-fisher-auto-catch{display:grid;grid-template-columns:64px minmax(0,1fr) auto;align-items:center;gap:10px;padding:8px 0;border-bottom:1px solid var(--fisher-ink)}
.dsh-fisher-auto-catch img{width:64px;height:64px;object-fit:contain;image-rendering:pixelated}.dsh-fisher-auto-catch small{display:block;margin-top:4px;color:var(--fisher-muted)}
...
.dsh-fisher-dialog{color:var(--fisher-ink);background:var(--fisher-paper);border:1px solid var(--fisher-ink);position:relative;inset:auto;margin:0;padding:0;width:100%;max-width:480px;max-height:100%;min-height:0;overflow:hidden;box-shadow:4px 4px 0 var(--fisher-ink);font:inherit;overscroll-behavior:contain}.dsh-fisher-dialog[open]{display:flex;flex-direction:column}.dsh-fisher-dialog-layer{position:absolute;inset:0;z-index:20;display:flex;align-items:center;justify-content:center;padding:12px;background:#17263688;overflow:hidden;isolation:isolate}.dsh-fisher-dialog-layer[inert]{pointer-events:none}.dsh-fisher-dialog h3{margin:0;font-size:17px;line-height:1.5}.dsh-fisher-dialog-content{padding:16px;overflow:auto;min-height:0;overscroll-behavior:contain}.dsh-fisher-dialog .dsh-fisher-actions{margin:12px 0}
...
.dsh-fisher-file-input{display:block;margin:15px 0}.dsh-fisher-file-input input{display:block;margin-top:8px;width:100%;font-size:12px}.dsh-fisher-dialog input[type=text],.dsh-fisher-dialog input:not([type]){display:block;width:100%;margin:8px 0 15px}
...
.dsh-fisher-plugin-setting{display:flex;align-items:center;justify-content:space-between;gap:16px;margin-bottom:20px;padding-bottom:16px;border-bottom:1px solid var(--fisher-muted)}.dsh-fisher-plugin-setting small{display:block;line-height:1.6;color:var(--fisher-muted);margin-top:4px}.dsh-fisher-settings .dsh-fisher-switch{width:48px;height:28px;min-height:28px;padding:3px;flex-shrink:0;border-radius:16px;box-shadow:none;background:var(--fisher-muted)}.dsh-fisher-switch span{display:block;width:20px;height:20px;border-radius:50%;background:var(--fisher-raised);transition:transform .15s}.dsh-fisher-settings .dsh-fisher-switch[aria-checked=true]{background:#397c74}.dsh-fisher-switch[aria-checked=true] span{transform:translateX(19px)}.dsh-fisher-settings[data-reduced-motion=true] .dsh-fisher-switch span{transition:none}
.dsh-fisher-location-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:12px}.dsh-fisher .dsh-fisher-location-card{display:flex;flex-direction:column;align-items:stretch;gap:4px;padding:0 0 10px;overflow:hidden;text-align:center}.dsh-fisher-location-card img{width:100%;height:112px;object-fit:cover;object-position:center 34%;image-rendering:pixelated;border-bottom:1px solid var(--fisher-ink)}.dsh-fisher-location-card[aria-pressed=true]{outline:2px solid var(--fisher-ink);outline-offset:2px;opacity:1}.dsh-fisher-location-card strong{font-size:14px}.dsh-fisher-location-card small{padding:0 4px}
/* The coast remains mounted beneath its edge controls and local dialogs. */
.dsh-fisher-panel[data-immersive=true]{container-type:size;isolation:isolate;background:#bedad4}
.dsh-fisher-panel[data-immersive=true]>.dsh-fisher-header{position:absolute;inset:0 0 auto;height:60px;z-index:8;padding:10px 12px;border:0;background:linear-gradient(#f7f1dfbb,#f7f1df00);pointer-events:none;min-height:0}
.dsh-fisher-panel[data-immersive=true]>.dsh-fisher-header:after{display:none}
.dsh-fisher-panel[data-immersive=true] .dsh-fisher-brand{pointer-events:auto;background:var(--fisher-raised);border:1px solid var(--fisher-ink);border-radius:9px;padding:6px 9px;gap:6px;box-shadow:0 3px 9px #263d4320;cursor:grab}
.dsh-fisher-panel[data-immersive=true] .dsh-fisher-brand>svg{width:23px;height:23px}.dsh-fisher-panel[data-immersive=true] .dsh-fisher-brand strong{font-size:14px}.dsh-fisher-panel[data-immersive=true] .dsh-fisher-brand small{display:none}
.dsh-fisher-panel[data-immersive=true] .dsh-fisher-header-actions{pointer-events:auto;gap:7px}.dsh-fisher-panel[data-immersive=true] .dsh-fisher-header-actions button{border-radius:9px;box-shadow:0 3px 9px #263d4320}
.dsh-fisher-panel[data-immersive=true]>.dsh-fisher-body{position:absolute;inset:0;display:block;overflow:hidden;min-height:0;padding:0}
.dsh-fisher-game[data-immersive=true]{position:absolute;inset:0;display:block;height:100%;min-height:0;padding:0;gap:0;overflow:hidden}
.dsh-fisher-game[data-immersive=true]>.dsh-fisher-world-stage,.dsh-fisher-game[data-immersive=true]>.dsh-fisher-play-scene{position:absolute;inset:0;width:100%;height:100%;min-height:0;max-height:none;border:0;margin:0;aspect-ratio:auto}
.dsh-fisher-panel[data-immersive=true]>.dsh-fisher-resize{z-index:10;bottom:0;right:0;width:18px;height:18px;background-color:#f4efdb88;border-radius:0;box-shadow:none}
.dsh-fisher-hud-top{position:absolute;z-index:5;top:64px;left:12px;right:12px;display:flex;justify-content:space-between;align-items:flex-start;gap:12px;pointer-events:none}
.dsh-fisher .dsh-fisher-hud-top button{pointer-events:auto;display:flex;align-items:center;gap:7px;padding:7px 10px;border-radius:9px;background:var(--fisher-raised);box-shadow:0 3px 9px #263d4320;font-size:12px;min-height:36px}
.dsh-fisher-hud-top svg{width:19px;height:19px}.dsh-fisher-hud-wallet{font-variant-numeric:tabular-nums;max-width:48%}
.dsh-fisher-hud-menu{position:absolute;z-index:5;right:12px;top:116px;display:flex;flex-direction:column;gap:8px}
.dsh-fisher .dsh-fisher-hud-menu button{width:48px;min-height:50px;padding:6px 3px;display:flex;align-items:center;justify-content:center;flex-direction:column;gap:3px;border-radius:10px;background:var(--fisher-raised);box-shadow:0 3px 9px #263d4325;font-size:10px;line-height:1.2}
.dsh-fisher-hud-menu svg{width:22px;height:22px}.dsh-fisher .dsh-fisher-hud-menu button[data-active=true]{background:#97cec5;color:#244f58;border-color:#345f62}
.dsh-fisher .dsh-fisher-hud-save{position:absolute;z-index:5;bottom:14px;left:12px;display:flex;align-items:center;gap:5px;font-size:10px;padding:5px 7px;border-radius:7px;box-shadow:0 2px 5px #263d4320;background:var(--fisher-raised)}
.dsh-fisher-hud-save svg{width:14px;height:14px}.dsh-fisher .dsh-fisher-hud-save[data-error=true]{background:var(--fisher-coral)}
.dsh-fisher-hud-fishing{position:absolute;bottom:27px;right:17px;z-index:5;display:flex;align-items:flex-end;gap:7px;max-width:calc(100% - 130px)}
.dsh-fisher-hud-fishing>.dsh-fisher-primary,.dsh-fisher-world-interaction>.dsh-fisher-primary{display:flex;flex-direction:column;align-items:center;gap:5px;min-width:105px;min-height:78px;border-radius:14px;padding:12px;background:#e9f1dedf;box-shadow:0 4px 12px #214f5a35;color:#293f46}
.dsh-fisher-hud-fishing svg,.dsh-fisher-world-interaction svg{width:26px;height:26px}.dsh-fisher-hud-fishing span,.dsh-fisher-world-interaction span{font-size:13px;font-weight:600}
.dsh-fisher-hud-fishing small,.dsh-fisher-world-interaction small{font-size:10px;line-height:1.4}.dsh-fisher-hud-fishing .dsh-fisher-hud-more{padding:8px;border-radius:10px;box-shadow:0 2px 5px #263d4320}.dsh-fisher-hud-more svg{width:19px;height:19px;display:block}
.dsh-fisher-hud-meter{width:100%;height:10px;display:block;background:linear-gradient(to right,#477f80 var(--catch),#c2d9cc var(--catch)) top/100% 3px no-repeat,linear-gradient(to right,#d09560 var(--tension),#dcd8b9 var(--tension)) bottom/100% 3px no-repeat}
.dsh-fisher .dsh-fisher-hud-fishing .is-reeling{background:#bedfcb}.dsh-fisher .dsh-fisher-hud-fishing .is-biting{background:#f7d49c}
...
@container (max-height:560px){.dsh-fisher-hud-menu{top:111px;gap:5px}.dsh-fisher .dsh-fisher-hud-menu button{width:43px;min-height:40px;padding:4px 3px}.dsh-fisher-hud-menu svg{width:17px;height:17px}.dsh-fisher .dsh-fisher-hud-menu button span{font-size:9px}.dsh-fisher-hud-fishing>.dsh-fisher-primary,.dsh-fisher-world-interaction>.dsh-fisher-primary{min-width:90px;min-height:65px;padding:8px}}
${paperUiStyles}
`;
