...
export function createConversation(React:typeof ReactTypes) {
  ...
  return function Conversation({definition,outfit,opening,onClose,onJournal,script,onComplete,disabled,error}:{definition:GuestDefinition;outfit:Outfit;opening?:string;onClose:()=>void;onJournal?:()=>void;script?:readonly ConversationLine[];onComplete?:()=>void;disabled?:boolean;error?:string|null}) {
