...
export const GUESTS: readonly GuestDefinition[]=[
  ...
  {id:'G003',name:'奶娃',region:'L02',alternate:'奶泡小雨衣',requirement:'在热梗湾发现 5 项条目',lines:[
    ...
    '奶娃第一次出远门时，只带了一只比自己还小的旅行杯。她把沿途听见的笑声想象成糖粒，认真数过以后装进杯里，虽然别人什么也看不见。到了热梗湾，她发现这里的收藏一个比一个奇怪，便决定暂时不走了。那天晚上，她给杯子贴了新标签，上面写着：在这里，奇怪也是一种欢迎。',
    '小雨衣做好那天，天上偏偏一朵雨云也没有。奶娃仍然穿着它，在码头和鱼缸之间走了好几趟，检查帽沿会不会遮住眼睛。后来一阵风送来两滴水，她高兴得像等到了一整场雨。你替她挪开椅子上的叶片，她便把那里宣布为自己的固定座位，还给明天也留了一个位置。']},
