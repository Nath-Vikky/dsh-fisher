...
const rows: readonly [string,string,number,number,number][]=[
  ...
  ['四处摸鱼','解锁全部 4 个地区',4,0,2],['手册写满','达到 Lv.20',20,200,0],['不太正常','首次发现奇珍异兽',1,30,0],['奇珍异兽收藏家','发现全部 12 项奇珍异兽',12,100,0],
  ['正经钓鱼','发现全部 28 种正常鱼',28,150,0],['海岸考古','发现全部 4 件遗物',4,0,3],['客人都来了','认识全部 4 位来客',4,0,3],['摸鱼海岸图鉴','发现全部 48 项，另获纪念卡边框',48,200,0],
